...
export const DEFAULT_FILE_NAME = `__${pkg.full}_default_main.ys.yml`;
...
export const GLOBAL_PACKAGE_PREFIX = config.globalPackageUrlPrefix + "@" +
  pkg.version;
export const GLOBAL_PACKAGE_URL = `${GLOBAL_PACKAGE_PREFIX}/globals/mod.ts`;

export const GLOBAL_RUNTIME_CMD_PACKAGE_URL =
  `${GLOBAL_PACKAGE_PREFIX}/globals/cmd/mod.ts`;
