...
import { template,precompile } from "./template.ts";
...
Deno.test("precomiple #8",()=>{
  const specs = {"main":function(__yaas_context:Record<string,unknown>){const name=__yaas_context['name'];return `Test ${name}`}};
